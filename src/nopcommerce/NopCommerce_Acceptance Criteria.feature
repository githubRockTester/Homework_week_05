Feature: Demo Nopcommerce's top menu acceptance criteria
  ...
  Scenario: Verify that ser can see "Grid" tab on Book Category page
    Given   User is on Books Category page
    When    User is on Books Category page
    And     Check "Grid" tab is present
    Then    "Grid" tab is available on Book Category page

  Scenario: Verify that ser can see "List" tab on Book Category page
    Given   User is on Books Category page
    When    User is on Books Category page
    And     Check "List" tab is present
    Then    "List" tab is available on Book Category page

  Scenario: Verify that ser can see "Name: A to Z" selection is present in "Sort by" filter
    Given   User is on Books Category page
    When    User is on Books Category page
  ...
  Scenario: Verify that ser can see "Name: A to Z" is first option in "Sort by" filter
    Given   User is on Books Category page
    When    User is on Books Category page
    And     Check "Sort by" filter
